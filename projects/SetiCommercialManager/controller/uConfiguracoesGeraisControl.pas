unit uConfiguracoesGeraisControl;

interface

uses uConfiguracoesGeraisDao, uConfiguracoesGeraisModel, uMess, SysUtils, Forms,
Buttons, StdCtrls, Vcl.Graphics,Windows,Messages,Variants,Classes,Controls,
Dialogs, DBGrids;

    type TConfiguracoesGeraisControl = class
      private
          FcModel : TConfiguracoesGeraisModel;
          FcDao : TConfiguracoesGeraisDao;
      ...
      published
          property cModel : TConfiguracoesGeraisModel read FcModel write FcModel;
          property cDao : TConfiguracoesGeraisDAO read FcDao write FcDao;

    end;

implementation

{ TConfiguracoesGeraisControl }

constructor TConfiguracoesGeraisControl.Create(Form: TObject);
begin
    try
...
procedure TConfiguracoesGeraisControl.DbGridSetValue(Form: TObject);
begin
    try
{        with (Form as TfrmForms) do
        begin
...
procedure TConfiguracoesGeraisControl.ParamSet(Form: TObject;State:Integer);
var
    pStatus : string;
begin
...
procedure TConfiguracoesGeraisControl.Search(Form: TObject);
begin
  try
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
...
procedure TConfiguracoesGeraisControl.BackRecords(Form:TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TConfiguracoesGeraisControl.Cancel(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TConfiguracoesGeraisControl.Save(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TConfiguracoesGeraisControl.Delete(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TConfiguracoesGeraisControl.New(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TConfiguracoesGeraisControl.Edit(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TConfiguracoesGeraisControl.Clear(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TConfiguracoesGeraisControl.Control(State: Integer; Form: TObject);
var
    i : Integer;
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
