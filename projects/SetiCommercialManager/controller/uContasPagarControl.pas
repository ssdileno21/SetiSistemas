unit uContasPagarControl;

interface

uses uContasPagarDao, uContasPagarModel, uMess, SysUtils, Forms, Buttons,
StdCtrls, Vcl.Graphics,Windows,Messages,Variants,Classes,Controls,Dialogs,
DBGrids;

    type TContasPagarControl = class
      private
          FcModel : TContasPagarModel;
          FcDao : TContasPagarDao;
      ...
      published
          property cModel : TContasPagarModel read FcModel write FcModel;
          property cDao : TContasPagarDao read FcDao write FcDao;
...
constructor TContasPagarControl.Create(Form: TObject);
begin
    try
...
procedure TContasPagarControl.DbGridSetValue(Form: TObject);
begin
    try
{        with (Form as TfrmForms) do
        begin
...
procedure TContasPagarControl.ParamSet(Form: TObject;State:Integer);
var
    pStatus : string;
begin
...
procedure TContasPagarControl.Search(Form: TObject);
begin
  try
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
...
procedure TContasPagarControl.BackRecords(Form:TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TContasPagarControl.Cancel(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TContasPagarControl.Save(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TContasPagarControl.Delete(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TContasPagarControl.New(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TContasPagarControl.Edit(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TContasPagarControl.Clear(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TContasPagarControl.Control(State: Integer; Form: TObject);
var
    i : Integer;
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
