unit uProdutoModelosControl;

interface

uses uProdutoModelosDao, uProdutoModelosModel, uMess, SysUtils, Forms, Buttons, StdCtrls,
Vcl.Graphics,Windows,Messages,Variants,Classes,Controls,Dialogs, DBGrids;

    type TProdutoModelosControl = class
      private
          FcModel : TProdutoModelosModel;
          FcDao : TProdutoModelosDao;
      ...
      published
          property cModel : TProdutoModelosModel read FcModel write FcModel;
          property cDao : TProdutoModelosDao read FcDao write FcDao;

    end;

implementation

{ TProdutoModelosControl }

constructor TProdutoModelosControl.Create(Form: TObject);
begin
    try
...
procedure TProdutoModelosControl.DbGridSetValue(Form: TObject);
begin
    try
{        with (Form as TfrmForms) do
        begin
...
procedure TProdutoModelosControl.ParamSet(Form: TObject;State:Integer);
var
    pStatus : string;
begin
...
procedure TProdutoModelosControl.Search(Form: TObject);
begin
  try
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
...
procedure TProdutoModelosControl.BackRecords(Form:TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TProdutoModelosControl.Cancel(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TProdutoModelosControl.Save(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TProdutoModelosControl.Delete(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TProdutoModelosControl.New(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TProdutoModelosControl.Edit(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TProdutoModelosControl.Clear(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TProdutoModelosControl.Control(State: Integer; Form: TObject);
var
    i : Integer;
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
