unit uContasBancariasControl;

interface

uses uContasBancariasDao, uContasBancariasModel, uMess, SysUtils, Forms,
Buttons, StdCtrls, Vcl.Graphics,Windows,Messages,Variants,Classes,Controls,
Dialogs, DBGrids;

    type TContasBancariasControl = class
      private
          FcModel : TContasBancariasModel;
          FcDao : TContasBancariasDao;
      ...
      published
          property cModel : TContasBancariasModel read FcModel write FcModel;
          property cDao : TContasBancariasDao read FcDao write FcDao;

    end;

implementation

{ TContasBancariasControl }

constructor TContasBancariasControl.Create(Form: TObject);
begin
    try
...
procedure TContasBancariasControl.DbGridSetValue(Form: TObject);
begin
    try
{        with (Form as TfrmForms) do
        begin
...
procedure TContasBancariasControl.ParamSet(Form: TObject;State:Integer);
var
    pStatus : string;
begin
...
procedure TContasBancariasControl.Search(Form: TObject);
begin
  try
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
...
procedure TContasBancariasControl.BackRecords(Form:TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TContasBancariasControl.Cancel(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TContasBancariasControl.Save(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TContasBancariasControl.Delete(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TContasBancariasControl.New(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TContasBancariasControl.Edit(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TContasBancariasControl.Clear(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TContasBancariasControl.Control(State: Integer; Form: TObject);
var
    i : Integer;
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
