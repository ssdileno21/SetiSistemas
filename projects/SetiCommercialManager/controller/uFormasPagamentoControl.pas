unit uFormasPagamentoControl;

interface

uses uFormasPagamentoDAO, uFormasPagamentoModel, uMess, SysUtils, Forms,
Buttons, StdCtrls, Vcl.Graphics,Windows,Messages,Variants,Classes,Controls,
Dialogs, DBGrids;

    type TFormasPagamentoControl = class
      private
          FcModel : TFormasPagamentoModel;
          FcDao : TFormasPagamentoDao;
      ...
      published
          property cModel : TFormasPagamentoModel read FcModel write FcModel;
          property cDao : TFormasPagamentoDao read FcDao write FcDao;
...
constructor TFormasPagamentoControl.Create(Form: TObject);
begin
    try
...
procedure TFormasPagamentoControl.DbGridSetValue(Form: TObject);
begin
    try
{        with (Form as TfrmForms) do
        begin
...
procedure TFormasPagamentoControl.ParamSet(Form: TObject;State:Integer);
var
    pStatus : string;
begin
...
procedure TFormasPagamentoControl.Search(Form: TObject);
begin
  try
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
...
procedure TFormasPagamentoControl.BackRecords(Form:TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TFormasPagamentoControl.Cancel(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TFormasPagamentoControl.Save(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TFormasPagamentoControl.Delete(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TFormasPagamentoControl.New(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TFormasPagamentoControl.Edit(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TFormasPagamentoControl.Clear(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TFormasPagamentoControl.Control(State: Integer; Form: TObject);
var
    i : Integer;
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
