unit uPedidoCompraControl;

interface

uses uPedidoCompraDao, uPedidoCompraModel, uMess, SysUtils, Forms, Buttons,
StdCtrls, Vcl.Graphics,Windows,Messages,Variants,Classes,Controls,Dialogs,
DBGrids;

    type TPedidoCompraControl = class
      private
          FcModel : TPedidoCompraModel;
          FcDao : TPedidoCompraDao;
      ...
      published
          property cModel : TPedidoCompraModel read FcModel write FcModel;
          property cDao : TPedidoCompraDao read FcDao write FcDao;

    end;

implementation

{ TPedidoCompraControl }

constructor TPedidoCompraControl.Create(Form: TObject);
begin
    try
...
procedure TPedidoCompraControl.DbGridSetValue(Form: TObject);
begin
    try
{        with (Form as TfrmForms) do
        begin
...
procedure TPedidoCompraControl.ParamSet(Form: TObject;State:Integer);
var
    pStatus : string;
begin
...
procedure TPedidoCompraControl.Search(Form: TObject);
begin
  try
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
...
procedure TPedidoCompraControl.BackRecords(Form:TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TPedidoCompraControl.Cancel(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TPedidoCompraControl.Save(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TPedidoCompraControl.Delete(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TPedidoCompraControl.New(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TPedidoCompraControl.Edit(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TPedidoCompraControl.Clear(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TPedidoCompraControl.Control(State: Integer; Form: TObject);
var
    i : Integer;
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
