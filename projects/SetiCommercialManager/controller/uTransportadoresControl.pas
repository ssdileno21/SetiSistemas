unit uTransportadoresControl;

interface

uses uTransportadoresDao, uTransportadoresModel, uMess, SysUtils, Forms,
Buttons, StdCtrls, Vcl.Graphics,Windows,Messages,Variants,Classes,Controls,
Dialogs, DBGrids;

    type TTransportadoresControl = class
      private
          FcModel : TTransportadoresModel;
          FcDao : TTransportadoresDao;
      ...
      published
          property cModel : TTransportadoresModel read FcModel write FcModel;
          property cDao : TTransportadoresDao read FcDao write FcDao;

    end;

implementation

{ TTransportadoresControl }

constructor TTransportadoresControl.Create(Form: TObject);
begin
    try
...
procedure TTransportadoresControl.DbGridSetValue(Form: TObject);
begin
    try
{        with (Form as TfrmForms) do
        begin
...
procedure TTransportadoresControl.ParamSet(Form: TObject;State:Integer);
var
    pStatus : string;
begin
...
procedure TTransportadoresControl.Search(Form: TObject);
begin
  try
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
...
procedure TTransportadoresControl.BackRecords(Form:TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TTransportadoresControl.Cancel(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TTransportadoresControl.Save(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TTransportadoresControl.Delete(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TTransportadoresControl.New(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TTransportadoresControl.Edit(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TTransportadoresControl.Clear(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TTransportadoresControl.Control(State: Integer; Form: TObject);
var
    i : Integer;
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
