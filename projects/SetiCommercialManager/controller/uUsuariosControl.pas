unit uUsuariosControl;

interface

uses uUsuariosDao, uUsuariosModel, uMess, SysUtils, Forms, Buttons, StdCtrls,
Vcl.Graphics,Windows,Messages,Variants,Classes,Controls,Dialogs, DBGrids;

    type TUsuariosControl = class
      private
          FcModel : TUsuariosModel;
          FcDao : TUsuariosDao;
      ...
      published
          property cModel : TUsuariosModel read FcModel write FcModel;
          property cDao : TUsuariosDao read FcDao write FcDao;
...
constructor TUsuariosControl.Create(Form: TObject);
begin
    try
...
procedure TUsuariosControl.DbGridSetValue(Form: TObject);
begin
    try
{        with (Form as TfrmForms) do
        begin
...
procedure TUsuariosControl.ParamSet(Form: TObject;State:Integer);
var
    pStatus : string;
begin
...
procedure TUsuariosControl.Search(Form: TObject);
begin
  try
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
...
procedure TUsuariosControl.BackRecords(Form:TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TUsuariosControl.Cancel(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TUsuariosControl.Save(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TUsuariosControl.Delete(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TUsuariosControl.New(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TUsuariosControl.Edit(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TUsuariosControl.Clear(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TUsuariosControl.Control(State: Integer; Form: TObject);
var
    i : Integer;
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
