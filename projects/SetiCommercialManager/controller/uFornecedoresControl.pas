unit uFornecedoresControl;

interface

uses uFornecedoresDao, uFornecedoresModel, uMess, SysUtils, Forms, Buttons,
StdCtrls, Vcl.Graphics,Windows,Messages,Variants,Classes,Controls,Dialogs,
DBGrids;

    type TFornecedoresControl = class
      private
          FcModel : TFornecedoresModel;
          FcDao : TFornecedoresDao;
      ...
      published
          property cModel : TFornecedoresModel read FcModel write FcModel;
          property cDao : TFornecedoresDao read FcDao write FcDao;

    end;

implementation

{ TFornecedoresControl }

constructor TFornecedoresControl.Create(Form: TObject);
begin
    try
...
procedure TFornecedoresControl.DbGridSetValue(Form: TObject);
begin
    try
{        with (Form as TfrmForms) do
        begin
...
procedure TFornecedoresControl.ParamSet(Form: TObject;State:Integer);
var
    pStatus : string;
begin
...
procedure TFornecedoresControl.Search(Form: TObject);
begin
  try
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
...
procedure TFornecedoresControl.BackRecords(Form:TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TFornecedoresControl.Cancel(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TFornecedoresControl.Save(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TFornecedoresControl.Delete(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TFornecedoresControl.New(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TFornecedoresControl.Edit(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TFornecedoresControl.Clear(Form: TObject);
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    6: SAVE; 7:CANCEL}
    try
...
procedure TFornecedoresControl.Control(State: Integer; Form: TObject);
var
    i : Integer;
begin
    {STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
