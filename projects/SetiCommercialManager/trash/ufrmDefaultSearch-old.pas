...
uses
  ...
  Data.Win.ADODB, Datasnap.Provider, uSetiUseful, uSetiConfig,
  System.StrUtils;
...
begin
  try
    ...
    begin
      ...
      if (TForm(qSender).Components[i].Tag <> SConfigTagNotSearchCompo) then
      begin
        vCompFieldName := '';
        vFieldName := '';
        //CDS DOS COMPONENTES
    ...
    begin
      ...
      //AdoQry.Connection := SConfigAdoConnection(True); DILENO
      AdoQry.SQL.Clear;
      cdsComp.Open;
...
begin
{
    ...
    try
      for I := 0 to ComponentCount -1 do begin
          if (Components[i].Tag <> SConfigTagNotControlComp) then begin
              //TEDIT
