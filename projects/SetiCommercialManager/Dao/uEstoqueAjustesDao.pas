unit uEstoqueAjustesDao;

interface

uses uEstoqueAjustesModel, uMess, SysUtils, uSetiConfig, uSetiConnects, SqlExpr,
ADODB, DB, Provider, DBClient, DBGrids, System.Variants, Dialogs;

    type TEstoqueAjustesDao = class(TProvider)
      private
      ...
      public
          ...
          function FormList(Model:TEstoqueAjustesModel;Grid:TDBGrid) : Boolean;
          procedure Insert(Model:TEstoqueAjustesModel);
          procedure Edit(Model:TEstoqueAjustesModel);
          procedure Delete(Model:TEstoqueAjustesModel);
          procedure Save(Model:TEstoqueAjustesModel);
...
procedure TEstoqueAjustesDao.CompCreate(Create:Boolean);
var
    pDb : string;
begin
    try
...
constructor TEstoqueAjustesDao.Create;
begin
    try
...
procedure TEstoqueAjustesDao.Delete(Model: TEstoqueAjustesModel);
begin
...
destructor TEstoqueAjustesDao.Destroy;
begin
    try
...
procedure TEstoqueAjustesDao.Edit(Model: TEstoqueAjustesModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
function TEstoqueAjustesDao.FormList(Model: TEstoqueAjustesModel; Grid:
TDBGrid) :
Boolean;
var
    pVal : Boolean;
...
procedure TEstoqueAjustesDao.Insert(Model: TEstoqueAjustesModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
procedure TEstoqueAjustesDao.ProviderFlags(DataSet: TDataSet);
begin
    try
      {with (DataSet) do
      begin
...
procedure TEstoqueAjustesDao.Save(Model: TEstoqueAjustesModel);
begin
    try
