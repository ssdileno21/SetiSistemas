...
uses uServicosModel, uMess, SysUtils, uSetiConfig, uSetiConnects, SqlExpr,
ADODB, DB, Provider, DBClient, DBGrids, System.Variants, Dialogs;

    type TServicosDao = class(TProvider)
      private
      ...
      public
          ...
          function FormList(Model:TServicosModel;Grid:TDBGrid) : Boolean;
          procedure Insert(Model:TServicosModel);
          procedure Edit(Model:TServicosModel);
          procedure Delete(Model:TServicosModel);
          procedure Save(Model:TServicosModel);
...
procedure TServicosDao.CompCreate(Create:Boolean);
var
    pDb : string;
begin
    try
...
procedure TServicosDao.Delete(Model: TServicosModel);
begin
...
procedure TServicosDao.Edit(Model: TServicosModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
function TServicosDao.FormList(Model: TServicosModel; Grid: TDBGrid) : Boolean;
var
    pVal : Boolean;
    pDb : string;
begin
...
procedure TServicosDao.Insert(Model: TServicosModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
procedure TServicosDao.ProviderFlags(DataSet: TDataSet);
begin
    try
      {with (DataSet) do
      begin
...
procedure TServicosDao.Save(Model: TServicosModel);
begin
    try
