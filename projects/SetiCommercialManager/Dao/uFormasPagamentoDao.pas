unit uFormasPagamentoDao;

interface

uses uFormasPagamentoModel, uMess, SysUtils, uSetiConfig, uSetiConnects, SqlExpr,
ADODB, DB, Provider, DBClient, DBGrids, System.Variants, Dialogs;

    type TFormasPagamentoDao = class(TProvider)
      private
      ...
      public
          ...
          function FormList(Model:TFormasPagamentoModel;Grid:TDBGrid) : Boolean;
          procedure Insert(Model:TFormasPagamentoModel);
          procedure Edit(Model:TFormasPagamentoModel);
          procedure Delete(Model:TFormasPagamentoModel);
          procedure Save(Model:TFormasPagamentoModel);
...
procedure TFormasPagamentoDao.CompCreate(Create:Boolean);
var
    pDb : string;
begin
    try
...
constructor TFormasPagamentoDao.Create;
begin
    try
...
procedure TFormasPagamentoDao.Delete(Model: TFormasPagamentoModel);
begin
...
destructor TFormasPagamentoDao.Destroy;
begin
    try
...
procedure TFormasPagamentoDao.Edit(Model: TFormasPagamentoModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
function TFormasPagamentoDao.FormList(Model: TFormasPagamentoModel; Grid: TDBGrid) : Boolean;
var
    pVal : Boolean;
    pDb : string;
begin
...
procedure TFormasPagamentoDao.Insert(Model: TFormasPagamentoModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
procedure TFormasPagamentoDao.ProviderFlags(DataSet: TDataSet);
begin
    try
      {with (DataSet) do
      begin
...
procedure TFormasPagamentoDao.Save(Model: TFormasPagamentoModel);
begin
    try
