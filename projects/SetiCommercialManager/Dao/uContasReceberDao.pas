...
uses uContasReceberModel, uMess, SysUtils, uSetiConfig, uSetiConnects, SqlExpr,
ADODB, DB, Provider, DBClient, DBGrids, System.Variants, Dialogs;

    type TContasReceberDao = class(TProvider)
      private
      ...
      public
          ...
          function FormList(Model:TContasReceberModel;Grid:TDBGrid) : Boolean;
          procedure Insert(Model:TContasReceberModel);
          procedure Edit(Model:TContasReceberModel);
          procedure Delete(Model:TContasReceberModel);
          procedure Save(Model:TContasReceberModel);
...
procedure TContasReceberDao.CompCreate(Create:Boolean);
var
    pDb : string;
begin
    try
...
procedure TContasReceberDao.Delete(Model: TContasReceberModel);
begin
...
procedure TContasReceberDao.Edit(Model: TContasReceberModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
function TContasReceberDao.FormList(Model: TContasReceberModel; Grid: TDBGrid)
: Boolean;
var
    pVal : Boolean;
    pDb : string;
...
procedure TContasReceberDao.Insert(Model: TContasReceberModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
procedure TContasReceberDao.ProviderFlags(DataSet: TDataSet);
begin
    try
      {with (DataSet) do
      begin
...
procedure TContasReceberDao.Save(Model: TContasReceberModel);
begin
    try
