...
ADODB, DB, Provider, DBClient, DBGrids, System.Variants, Dialogs;
    ...
    type TClassDao = class(TProvider)
      private
...
procedure TClassDao.CompCreate(Create:Boolean);
var
    pDb : string;
begin
    try
...
procedure TClassDao.Delete(Model: TSetiFormModel);
begin
...
procedure TClassDao.Edit(Model: TSetiFormModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
function TClassDao.FormList(Model: TSetiFormModel; Grid: TDBGrid) : Boolean;
var
    pVal : Boolean;
    pDb : string;
begin
...
procedure TClassDao.Insert(Model: TSetiFormModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
procedure TClassDao.ProviderFlags(DataSet: TDataSet);
begin
    try
      {with (DataSet) do
      begin
...
procedure TClassDao.Save(Model: TSetiFormModel);
begin
    try
