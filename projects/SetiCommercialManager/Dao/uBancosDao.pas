...
uses uBancosModel, uMess, SysUtils, uSetiConfig, uSetiConnects, SqlExpr,
ADODB, DB, Provider, DBClient, DBGrids, System.Variants, Dialogs;

    type TBancosDao = class(TProvider)
      private
      ...
      public
          ...
          function FormList(Model:TBancosModel;Grid:TDBGrid) : Boolean;
          procedure Insert(Model:TBancosModel);
          procedure Edit(Model:TBancosModel);
          procedure Delete(Model:TBancosModel);
          procedure Save(Model:TBancosModel);
...
procedure TBancosDao.CompCreate(Create:Boolean);
var
    pDb : string;
begin
    try
...
procedure TBancosDao.Delete(Model: TBancosModel);
begin
...
procedure TBancosDao.Edit(Model: TBancosModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
function TBancosDao.FormList(Model: TBancosModel; Grid: TDBGrid) : Boolean;
var
    pVal : Boolean;
    pDb : string;
begin
...
procedure TBancosDao.Insert(Model: TBancosModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
procedure TBancosDao.ProviderFlags(DataSet: TDataSet);
begin
    try
      {with (DataSet) do
      begin
...
procedure TBancosDao.Save(Model: TBancosModel);
begin
    try
