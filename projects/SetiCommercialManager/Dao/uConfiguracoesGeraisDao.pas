unit uConfiguracoesGeraisDao;

interface

uses uConfiguracoesGeraisModel, uMess, SysUtils, uSetiConfig, uSetiConnects, SqlExpr,
ADODB, DB, Provider, DBClient, DBGrids, System.Variants, Dialogs;

    type TConfiguracoesGeraisDao = class(TProvider)
      private
      ...
      public
          ...
          function FormList(Model:TConfiguracoesGeraisModel;Grid:TDBGrid) : Boolean;
          procedure Insert(Model:TConfiguracoesGeraisModel);
          procedure Edit(Model:TConfiguracoesGeraisModel);
          procedure Delete(Model:TConfiguracoesGeraisModel);
          procedure Save(Model:TConfiguracoesGeraisModel);
...
{ TConfiguracoesGeraisDao }

procedure TConfiguracoesGeraisDao.CompCreate(Create:Boolean);
var
    pDb : string;
begin
    try
...
constructor TConfiguracoesGeraisDao.Create;
begin
    try
...
procedure TConfiguracoesGeraisDao.Delete(Model: TConfiguracoesGeraisModel);
begin
...
destructor TConfiguracoesGeraisDao.Destroy;
begin
    try
...
procedure TConfiguracoesGeraisDao.Edit(Model: TConfiguracoesGeraisModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
function TConfiguracoesGeraisDao.FormList(Model: TConfiguracoesGeraisModel;
Grid: TDBGrid) : Boolean;
var
    pVal : Boolean;
    pDb : string;
begin
...
procedure TConfiguracoesGeraisDao.Insert(Model: TConfiguracoesGeraisModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
procedure TConfiguracoesGeraisDao.ProviderFlags(DataSet: TDataSet);
begin
    try
      {with (DataSet) do
      begin
...
procedure TConfiguracoesGeraisDao.Save(Model: TConfiguracoesGeraisModel);
begin
    try
