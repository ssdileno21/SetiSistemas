...
function TServicosModel.GetCaption: string;
begin
    try
        Result := FCaption;
...
function TServicosModel.GetId: Integer;
begin
    try
        Result := FId;
    except on e : exception do
...
function TServicosModel.GetName: string;
begin
    try
        Result := FName;
    except on e : exception do
...
function TServicosModel.GetNewCaption: string;
begin
    try
        Result := FNewCaption;
    except on e : exception do
...
function TServicosModel.GetNewId: Integer;
begin
    try
        Result := FNewId;
    except on e : exception do
...
function TServicosModel.GetNewName: string;
begin
    try
        Result := FNewName;
    except on e : exception do
...
function TServicosModel.GetNewStatus: string;
begin
    try
        Result := FNewStatus;
    except on e : exception do
...
function TServicosModel.GetNewTag: string;
begin
    try
        Result := FNewTag;
    except on e : exception do
...
function TServicosModel.GetState: Integer;
begin
    try
        Result := FState;
    except on e : exception do
...
function TServicosModel.GetStatus: string;
begin
    try
        Result := FStatus;
    except on e : exception do
...
function TServicosModel.GetTag: string;
begin
    try
        Result := FTag;
    except on e : exception do
...
procedure TServicosModel.SetCaption(const Value: string);
begin
    try
...
procedure TServicosModel.SetId(const Value: Integer);
begin
    try
        FId := Value;
    except on e : exception do
...
procedure TServicosModel.SetName(const Value: string);
begin
    try
...
procedure TServicosModel.SetNewCaption(const Value: string);
begin
    try
...
procedure TServicosModel.SetNewId(const Value: Integer);
begin
    try
      FNewId := Value;
    except on e : exception do
...
procedure TServicosModel.SetNewName(const Value: string);
begin
    try
...
procedure TServicosModel.SetNewStatus(const Value: string);
begin
    try
...
procedure TServicosModel.SetNewTag(const Value: string);
begin
    try
...
procedure TServicosModel.SetState(const Value: Integer);
begin
    try
      FState := Value;
    except on e : exception do
...
procedure TServicosModel.SetStatus(const Value: string);
begin
    try
      FStatus := Value;
    except on e : exception do
...
procedure TServicosModel.SetTag(const Value: string);
begin
    try
      FTag := Value;
    except on e : exception do
