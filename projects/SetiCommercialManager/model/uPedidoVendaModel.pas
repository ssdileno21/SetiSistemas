...
function TPedidoVendaModel.GetCaption: string;
begin
    try
        Result := FCaption;
...
function TPedidoVendaModel.GetName: string;
begin
    try
        Result := FName;
    except on e : exception do
...
function TPedidoVendaModel.GetNewCaption: string;
begin
    try
        Result := FNewCaption;
    except on e : exception do
...
function TPedidoVendaModel.GetNewId: Integer;
begin
    try
        Result := FNewId;
    except on e : exception do
...
function TPedidoVendaModel.GetNewName: string;
begin
    try
        Result := FNewName;
    except on e : exception do
...
function TPedidoVendaModel.GetNewStatus: string;
begin
    try
        Result := FNewStatus;
    except on e : exception do
...
function TPedidoVendaModel.GetNewTag: string;
begin
    try
        Result := FNewTag;
    except on e : exception do
...
function TPedidoVendaModel.GetState: Integer;
begin
    try
        Result := FState;
    except on e : exception do
...
function TPedidoVendaModel.GetStatus: string;
begin
    try
        Result := FStatus;
    except on e : exception do
...
function TPedidoVendaModel.GetTag: string;
begin
    try
        Result := FTag;
    except on e : exception do
...
procedure TPedidoVendaModel.SetCaption(const Value: string);
begin
    try
...
procedure TPedidoVendaModel.SetName(const Value: string);
begin
    try
...
procedure TPedidoVendaModel.SetNewCaption(const Value: string);
begin
    try
...
procedure TPedidoVendaModel.SetNewId(const Value: Integer);
begin
    try
      FNewId := Value;
    except on e : exception do
...
procedure TPedidoVendaModel.SetNewName(const Value: string);
begin
    try
...
procedure TPedidoVendaModel.SetNewStatus(const Value: string);
begin
    try
...
procedure TPedidoVendaModel.SetNewTag(const Value: string);
begin
    try
...
procedure TPedidoVendaModel.SetState(const Value: Integer);
begin
    try
      FState := Value;
    except on e : exception do
...
procedure TPedidoVendaModel.SetStatus(const Value: string);
begin
    try
      FStatus := Value;
    except on e : exception do
...
procedure TPedidoVendaModel.SetTag(const Value: string);
begin
    try
      FTag := Value;
    except on e : exception do
