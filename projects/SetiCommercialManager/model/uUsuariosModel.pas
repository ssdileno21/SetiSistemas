...
function TUsuariosModel.GetCaption: string;
begin
    try
        Result := FCaption;
...
function TUsuariosModel.GetId: Integer;
begin
    try
        Result := FId;
    except on e : exception do
...
function TUsuariosModel.GetName: string;
begin
    try
        Result := FName;
    except on e : exception do
...
function TUsuariosModel.GetNewCaption: string;
begin
    try
        Result := FNewCaption;
    except on e : exception do
...
function TUsuariosModel.GetNewId: Integer;
begin
    try
        Result := FNewId;
    except on e : exception do
...
function TUsuariosModel.GetNewName: string;
begin
    try
        Result := FNewName;
    except on e : exception do
...
function TUsuariosModel.GetNewStatus: string;
begin
    try
        Result := FNewStatus;
    except on e : exception do
...
function TUsuariosModel.GetNewTag: string;
begin
    try
        Result := FNewTag;
    except on e : exception do
...
function TUsuariosModel.GetState: Integer;
begin
    try
        Result := FState;
    except on e : exception do
...
function TUsuariosModel.GetStatus: string;
begin
    try
        Result := FStatus;
    except on e : exception do
...
function TUsuariosModel.GetTag: string;
begin
    try
        Result := FTag;
    except on e : exception do
...
procedure TUsuariosModel.SetCaption(const Value: string);
begin
    try
...
procedure TUsuariosModel.SetId(const Value: Integer);
begin
    try
        FId := Value;
    except on e : exception do
...
procedure TUsuariosModel.SetName(const Value: string);
begin
    try
...
procedure TUsuariosModel.SetNewCaption(const Value: string);
begin
    try
...
procedure TUsuariosModel.SetNewId(const Value: Integer);
begin
    try
      FNewId := Value;
    except on e : exception do
...
procedure TUsuariosModel.SetNewName(const Value: string);
begin
    try
...
procedure TUsuariosModel.SetNewStatus(const Value: string);
begin
    try
...
procedure TUsuariosModel.SetNewTag(const Value: string);
begin
    try
...
procedure TUsuariosModel.SetState(const Value: Integer);
begin
    try
      FState := Value;
    except on e : exception do
...
procedure TUsuariosModel.SetStatus(const Value: string);
begin
    try
      FStatus := Value;
    except on e : exception do
...
procedure TUsuariosModel.SetTag(const Value: string);
begin
    try
      FTag := Value;
    except on e : exception do
