...
function TClientesModel.GetCaption: string;
begin
    try
        Result := FCaption;
...
function TClientesModel.GetId: Integer;
begin
    try
        Result := FId;
    except on e : exception do
...
function TClientesModel.GetName: string;
begin
    try
        Result := FName;
    except on e : exception do
...
function TClientesModel.GetNewCaption: string;
begin
    try
        Result := FNewCaption;
    except on e : exception do
...
function TClientesModel.GetNewId: Integer;
begin
    try
        Result := FNewId;
    except on e : exception do
...
function TClientesModel.GetNewName: string;
begin
    try
        Result := FNewName;
    except on e : exception do
...
function TClientesModel.GetNewStatus: string;
begin
    try
        Result := FNewStatus;
    except on e : exception do
...
function TClientesModel.GetNewTag: string;
begin
    try
        Result := FNewTag;
    except on e : exception do
...
function TClientesModel.GetState: Integer;
begin
    try
        Result := FState;
    except on e : exception do
...
function TClientesModel.GetStatus: string;
begin
    try
        Result := FStatus;
    except on e : exception do
...
function TClientesModel.GetTag: string;
begin
    try
        Result := FTag;
    except on e : exception do
...
procedure TClientesModel.SetCaption(const Value: string);
begin
    try
...
procedure TClientesModel.SetName(const Value: string);
begin
    try
...
procedure TClientesModel.SetNewCaption(const Value: string);
begin
    try
...
procedure TClientesModel.SetNewId(const Value: Integer);
begin
    try
      FNewId := Value;
    except on e : exception do
...
procedure TClientesModel.SetNewName(const Value: string);
begin
    try
...
procedure TClientesModel.SetNewStatus(const Value: string);
begin
    try
...
procedure TClientesModel.SetNewTag(const Value: string);
begin
    try
...
procedure TClientesModel.SetState(const Value: Integer);
begin
    try
      FState := Value;
    except on e : exception do
...
procedure TClientesModel.SetStatus(const Value: string);
begin
    try
      FStatus := Value;
    except on e : exception do
...
procedure TClientesModel.SetTag(const Value: string);
begin
    try
      FTag := Value;
    except on e : exception do
