...
ADODB, DB, Provider, DBClient, DBGrids, System.Variants, Dialogs;
    ...
    type TSetiFormDao = class(TProvider)
      private
...
uses uSetiConstantesDB;


{ TSetiFormDao }

procedure TSetiFormDao.CompCreate(Create:Boolean);
var
    pDb : string;
begin
    try
        ...
        begin
            ...
            begin
              ...
              qSql.SQLConnection := qConnects.ConnectsFIREBIRD(True);
              qDsp.DataSet := qSql;
            end;
...
constructor TSetiFormDao.Create;
begin
    try
...
procedure TSetiFormDao.Delete(Model: TSetiFormModel);
begin
...
destructor TSetiFormDao.Destroy;
begin
    try
...
procedure TSetiFormDao.Edit(Model: TSetiFormModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
function TSetiFormDao.FormList(Model: TSetiFormModel; Grid: TDBGrid) : Boolean;
var
    pVal : Boolean;
    pDb : string;
begin
...
procedure TSetiFormDao.Insert(Model: TSetiFormModel);
begin
    //STATE: 1: INICIAL; 2: SEARCH; 3: INSERT; 4: EDIT; 5: CLEAR;
    try
...
procedure TSetiFormDao.ProviderFlags(DataSet: TDataSet);
begin
    try
      with (DataSet) do
      begin
...
procedure TSetiFormDao.Save(Model: TSetiFormModel);
begin
    try
