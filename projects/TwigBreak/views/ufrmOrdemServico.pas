...
procedure TfrmOrdemServico.Criar;
var
  i : Integer;
begin
    try
...
procedure TfrmOrdemServico.dbeVlrCustoExit(Sender: TObject);
begin
  FormataValorDbedit(dbeVlrCusto);
end;

procedure TfrmOrdemServico.dbeVlrCustoFinalChange(Sender: TObject);
begin
  FormataValorDbedit(dbeVlrCustoFinal);
end;

procedure TfrmOrdemServico.dbeVlrDespesasExit(Sender: TObject);
begin
  FormataValorDbedit(dbeVlrDespesas);
end;

procedure TfrmOrdemServico.dbeVlrOutrasDespesasExit(Sender: TObject);
begin
  FormataValorDbedit(dbeVlrOutrasDespesas);
end;

procedure TfrmOrdemServico.dbeVlrVendaSugeridoChange(Sender: TObject);
begin
  FormataValorDbedit(dbeVlrVendaSugerido);
end;

procedure TfrmOrdemServico.dbeVlrVendaUtilizadoExit(Sender: TObject);
begin
  FormataValorDbedit(dbeVlrVendaUtilizado);
end;

procedure TfrmOrdemServico.Deletar;
begin
    try
...
procedure TfrmOrdemServico.Editar;
begin
    try
...
procedure TfrmOrdemServico.FormataValorDbedit(pDbEdit: TDBEdit);
begin
...
function TfrmOrdemServico.GetStatus: string;
begin
    Result := FStatus;
end;

procedure TfrmOrdemServico.Gravar;
begin
    try
...
procedure TfrmOrdemServico.CompControle;
var
  iStatus : Integer;
  reg : Boolean;
  i : Integer;
...
procedure TfrmOrdemServico.Abrir;
var
  i : Integer;
begin
    try
...
procedure TfrmOrdemServico.Inserir;
begin
    try
      dmMasterDataModule.SetiCds.Open;
      dbgProducts.DataSource := nil;
...
procedure TfrmOrdemServico.ProviderFlags;
var
  i : Integer;
  vTab : string;
  vteste : Variant;
...
procedure TfrmOrdemServico.SetStatus(const Value: string);
begin
    FStatus := Value;
end;

procedure TfrmOrdemServico.sbAbrirClick(Sender: TObject);
begin
    try
      Abrir;
    except on e : exception do
...
procedure TfrmOrdemServico.sbCancelClick(Sender: TObject);
begin
    try
...
procedure TfrmOrdemServico.sbDelClick(Sender: TObject);
begin
    try
      Deletar;
    except on e : exception do
...
procedure TfrmOrdemServico.sbInsertClick(Sender: TObject);
begin
    try
      Inserir;
    except on e : exception do
...
procedure TfrmOrdemServico.sbSaveClick(Sender: TObject);
begin
    try
      try
        if (dbeNome.Text = '') then
...
procedure TfrmOrdemServico.sbUpdateClick(Sender: TObject);
begin
    try
      Editar;
    except on e : exception do
