...
procedure TfrmClientes.dbeCelularKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TfrmClientes.dbeCpfCnpjKeyPress(Sender: TObject; var Key: Char);
begin
    if not (key in ['0'..'9',#8]) then
     key:=#0;
end;
...
procedure TfrmClientes.dbgPadraoTitleClick(Column: TColumn);
begin
  SetiUsefulOrdenaGrid(dbgPadrao,Column);
end;

procedure TfrmClientes.Deletar;
var
  vRec : Integer;
begin
    try
...
function TfrmClientes.GetStatus: string;
begin
    Result := FStatus;
end;
...
procedure TfrmClientes.CompControle;
var
  iStatus : Integer;
  reg : Boolean;
  i : Integer;
begin
    try
      ...
      begin
        ...
        PageControl1.ActivePageIndex := 0;
        dbeNome.SetFocus;
        edtDatAniversario.Enabled := True;
        dbgPadrao.DataSource := qDsAux;
      end else
...
procedure TfrmClientes.ProviderFlags;
var
  i, i2 : Integer;
  vTab : string;
  vteste : Variant;
...
procedure TfrmClientes.SetStatus(const Value: string);
begin
    FStatus := Value;
end;

procedure TfrmClientes.sbExcelClick(Sender: TObject);
begin
...
procedure TfrmClientes.sbAbrirClick(Sender: TObject);
begin
    Abrir;
end;

procedure TfrmClientes.sbCancelClick(Sender: TObject);
begin
    try
...
procedure TfrmClientes.sbDelClick(Sender: TObject);
begin
    Deletar;
end;

procedure TfrmClientes.sbInsertClick(Sender: TObject);
begin
    Inserir;
end;

procedure TfrmClientes.sbSaveClick(Sender: TObject);
begin
    Gravar;
end;

procedure TfrmClientes.sbUpdateClick(Sender: TObject);
begin
    Editar;
end;
