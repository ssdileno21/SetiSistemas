...
uses
  ...
  Data.SqlExpr, Datasnap.Provider, uSetiConnects;
...
type
  ...
  public
    ...
    property ExibirMensUpdate : Boolean read FExibirMensUpdate write
      SetExibirMensUpdate;
    property ValidateToSave : Boolean read FValidateToSave write SetValidateToSave;
    property VerifButtonClick : Boolean read FVerifButtonClick write SetVerifButtonClick;
  end;
