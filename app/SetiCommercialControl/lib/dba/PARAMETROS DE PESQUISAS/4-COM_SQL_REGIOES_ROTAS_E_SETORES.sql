...
,'Cod.Regioes'--PARAMETER_3 - Titulo para o campo de pesquisa
,'Retorna regiao'--PARAMETER_4 - Titulo para a tela de pesquisa
,'TBCADREGIOES'--PARAMETER_5 - Nome da tabela - PARAMETER_2 = 0
,'SELECT * FROM TBCADREGIOES WHERE 1 = 1 '--PARAMETER_6 - Comando sql, tentar reduzir ao max, usar '' where 1 = 1  '' - PARAMETER_2 = 1
...
,5-- PARAMETER_15 - Cod.parametro para a tabela TBPROVIDERPARAMS
