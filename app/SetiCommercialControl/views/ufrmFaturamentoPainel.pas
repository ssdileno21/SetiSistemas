...
uses
  ...
  System.Classes, Vcl.Graphics, MIDASLIB, Vcl.Controls, Vcl.Forms, Vcl.Dialogs,
  Vcl.ExtCtrls, Vcl.ComCtrls, Vcl.Grids, Vcl.DBGrids, Vcl.StdCtrls,
  Vcl.Buttons, Data.FMTBcd, Data.DB, Data.SqlExpr, uSetiConnects, Vcl.Mask,
...
begin
    try
      ...
      sqlVendas.SQL.Add( ',SUM(COALESCE(V.vlr_total_final,0.00))             ');
      sqlVendas.SQL.Add( '  AS VLRTOTALVENDAS                                ');
      sqlVendas.SQL.Add( 'FROM tbvendas V                                    ');
      sqlVendas.SQL.Add( 'LEFT JOIN tbformapagto FP ON                       ');
      sqlVendas.SQL.Add( '  V.id_formapagto = FP.id                          ');
