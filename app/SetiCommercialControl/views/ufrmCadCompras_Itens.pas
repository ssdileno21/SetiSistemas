...
uses
  ...
  uSetiConnects, Vcl.ImgList, Vcl.Buttons, uLocate, MIDASLIB;
...
begin
  ...
  begin
    try
      ...
      vSql.ExecSQL;
      SetiMens(1,'Produto inserido com sucesso, você poderá remove-lo se'+
                 ' preferir, no término desta mensagem, ou nas seguintes'+
                 ' condições: '+#13+
                 ' * Pedido em aberto;' +#13+
                 ' * Pedido em modo de alteração;' +#13+
...
begin
    ...
    begin
      ...
      if edtVlrCusto.Text = '' then
      begin
        SetiMens(1,'Valor de custo não informado.');
        Exit;
      end;
      if edtQtdProduto.Text = '' then
      begin
...
begin
    try
      ...
      begin
        ...
        begin
          FieldByName('ID_CADCOMPRAS').DisplayLabel := 'Cód.Compra';
...
begin
  ...
  begin
    SetiMens(2,'Produto não cadastrado');
    Exit;
  end;
end;
