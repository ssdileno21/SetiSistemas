...
begin
    try
      ...
      begin
        ...
        begin
          SetiMens('Para atualizar as vendas, será necessário informar o '+
          'cliente e gravar a venda com a informação do mesmo preenchida.',2);
          Exit;
        end else
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              begin
                SetiMens('Cliente não informado',2);
                Exit;
              end;
              if (NpVendedor = -1) then
              begin
                SetiMens('Vendedor não informado',2);
                Exit;
              end;
              sbInsertClick(Self);
            ...
            begin
              SetiMens('Não existem produtos lançados no estoque atual.');
              Exit;
            end;
          end else Exit;
        end else Exit;
...
begin
    try
      ...
      begin
        ...
        begin
          SetiMens('Para efetur o pagamento, será necessário informar o '+
          'vendedor e gravar a venda com a informação do mesmo preenchida.',2);
          Exit;
        end;
...
begin
    try
      ...
      begin
        SetiMens('Valor unitário não informado.',2);
        Exit;
      end;
      if (edtVlrUnitario.Text <> '') then
      begin
        ...
        begin
          SetiMens('O valor unitário informado é inválido.',2);
          Exit;
        end;
      end;
...
begin
    try
      ...
      begin
        ...
        begin
          SetiMens('Exitem lançamentos realizados nesta venda para este '+
          ' cliente, portanto o mesmo não pode ser alterado, zere os '+
          ' lançamentos atuais realizar esta alteração.',2);
          Exit;
        end;
      end;
...
begin
    try
      if SetiMensQuestions('Confirma geração de um novo pedido a partir '+
...
begin
    ...
    begin
      SetiMens('Esta venda não pode ser alterada.',2);
      Exit;
    end;
end;
