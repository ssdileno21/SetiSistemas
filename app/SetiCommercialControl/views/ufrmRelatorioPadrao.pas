...
uses
  ...
  Vcl.ExtCtrls, Vcl.DBCtrls, Vcl.Grids, Vcl.DBGrids, Vcl.Buttons, Data.FMTBcd,
  Data.DB, Datasnap.DBClient, Datasnap.Provider, Data.SqlExpr, Vcl.Mask,
  Vcl.StdCtrls, Vcl.CheckLst, Vcl.ComCtrls, Vcl.ImgList, uSetiConnects,
  uLocate;
