...
uses
  ...
  System.Classes, Vcl.Graphics, MIDASLIB, uFSUF,
...
type
  TfrmMain = class(TForm)
    ...
    procedure mMov_Sai_ControlVendamanualClick(Sender: TObject);
  private
    FqUsuNome: string;
    FqUsuId: integer;
    FqUsuLogin: string;
...
uses uFSDialogs, uSetiConfig, ufrmLogin, ufrmCadRotas,
  ufrmCadRegioes, ufrmCadSetores,
  ufrmControleVendaManual, ufrmCadFormaPagto, uRepVendaManual,
  ufrmccnCadEmpresa, ufrmccnCadUsuarios, ufrmStanRec,
...
procedure TfrmMain.mMov_Sai_ControlVendamanualClick(Sender: TObject);
begin
    sbReciboVendaClick(Self);
end;
...
begin
    try
      ...
      begin
          ...
          frmLogin.Hide;
          StatusBar1.Panels[0].Text := SConfigVersao;
          StatusBar1.Panels[1].Text := 'Usuário: '+qUsuNome;
      end;
    finally
