...
begin
    ...
    try
      ...
      begin
        ...
        'Após o cancelamento, a venda não poderá ser alterada. ',0) then
        begin
    ...
    try
      ...
      begin
        ...
        begin
          ...
          begin
            SetiMens('Forma de pagamento não informada',2);
            Exit;
          end;
          ...
          'Após o pagamento, a venda não poderá ser alterada. ',0) then
          begin
            CommAtPagamento;
...
begin
    ...
    try
      if (coPedidoCds.State in [dsBrowse]) then
      begin
          if (SetiMensQuestions('Confirma exclusão do registro?',0)) then
          begin
            coPedidoCds.Delete;
            coPedidoCds.ApplyUpdates(0);
            coPedidoCds.Refresh;
            SetiMens('Registro excluído com sucesso.');
          end;
      end;
    finally
