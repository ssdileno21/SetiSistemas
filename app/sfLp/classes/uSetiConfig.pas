...
Const
    ...
    SConfigProjectPath = 'C:\SetiSistemas\app\sfLp';
    SConfigExePath = 'C:\SetiSistemas\app\sfLp\bin';

    // >> Dados do projeto atual
    SConfigSoftwareCaption = 'Seti Sistemas - Lançamentos pessoais';
    SConfigReducedSoftwareName = 'SLP';
    SConfigSoftwareExeName = 'LancamentosPessoais.exe';
    SConfigProjectID = 2;
    ...
    //será considerado casos que estoque ou a contagem for informada.
    ...
    // >> >> Usuário
    SConfigFBFrameworkDBUserName = '';
    // >> >> Senha
    SConfigFBFrameworkDBPassword = '';
    // >> >> Caminho
    SConfigFBFrameworkDBFilePath = '' +
      SConfigFBFrameworkDBName;
    ...
    // >> >> Usuário
    SConfigFBClientDBUserName = '';
    // >> >> Senha
    SConfigFBClientDBPassword = '';
    // >> >> Caminho
    SConfigFBClientDBFilePath = '' + SConfigFBClientDBName;
