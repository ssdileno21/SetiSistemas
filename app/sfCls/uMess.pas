...
begin
    try
        if (Id = 0) then //ERROR
          MessageDlg(ErrorAlert +#13+ Mess +#13+ Contato,mtError,
          [mbOK],0) else
        if (Id = 1) then //NORMAL
