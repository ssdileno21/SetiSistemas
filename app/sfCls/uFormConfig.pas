...

{
        ...
        LEMBRANDO QUE AS CONDIÇÕES DEVERAO SER CRIADAS NAS RESPECTIVAS
        FUNCTIONS...
}
...
begin
{
  --- METODO DE PARAMETRIZAÇÃO PARA A TELA DE PESQUISA PADRAO ---
    ...
    try
      ...
      begin
        ...
        begin
          ...
          begin
            p0:=pFormTag;
            {PARAMETROS - CRIE QUANTOS QUISER, LEMBRAR DE CRIAR AS CONDIÇÕES,
...
//            end else
        ...
        {acrescentar aqui as outras condições de outros forms...}
      end;
  {
  p0 =  TAG DO FORM;

  p1 =  FIELD DE PESQUISA;                     (ForSearch1GetFieldName)           30
  p2 =  COMANDO SQL;                           (ForSearch2SqlCommand)             2
  p3 =  COMANDO SP SQL (STORED PROCEDURE);     (ForSearch3SqlSPCommand)           0
  p4 =  QUANTIDADE DE PARAMETROS PARA A SP;    (ForSearch4GetNumParamsSP)         0
  p5 =  NOME DA TABELA;                        (ForSearch5GetTableName)           2
  p6 =  CAMPO CHAVE DA TABELA;                 (ForSearch6KeyFieldSearch)         2
  p7 =  CLAUSULA WHERE;                        (ForSearch7GetWhere)               2
  p8 =  ORDER BY;                              (ForSearch8GetOrderBy)             3
  p9 =  GROUP BY;                              (ForSearch9GetGroupBy)             0
  p10 = FIELD DE RETORNO;                      (ForSearch10GetReturnFieldName)    30
  p11 = ID PROVIDER PARAMS;                    (ForSearch11GetProviderParams)     2
   }
      SetParam0(p0);
      SetParam1(p1);
      SetParam2(p2);
...
begin
    ...
    begin
      ...
      {acrescentar aqui as outras condições...}
