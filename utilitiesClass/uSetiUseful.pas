...
uses
  Winsock, Forms, dbctrls, Dialogs, SysUtils, Windows, dbgrids, DB, Graphics,
  Classes, ComObj, ADODB, Variants, ComCtrls, DateUtils,Excel2000, Math,Grids,
  Types, Registry, Controls, StrUtils,IdBaseComponent, IdComponent, IdIPWatch,
  ShellAPI, DBClient, IniFiles, MIDASLIB, uMess, Messages, StdCtrls;
...
procedure TDial.InputBoxSetPasswordChar(var Msg: TMessage);
var
